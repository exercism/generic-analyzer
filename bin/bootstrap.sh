...
help_and_exit() {
    echo >&2 "Create an analyzer repository for a track."
...
# Add topics
gh api --method PUT "/repos/${REPO}/topics" -f "names[]=exercism-analyzer" -f "names[]=exercism-tooling"
